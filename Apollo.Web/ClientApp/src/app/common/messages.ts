export let ErrorMessages = {
  ...
  validateAppRole: 'This application type is already selected.',
  validateAppRoleNotNull: 'Please select the role for the selected application'
};
...
export let InfoMessages = {
  ...
  flatUpdateMessage: 'Flat has been updated successfully',
