...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<ApolloUser> _signInManager;
        ...
        private async Task<(ApolloUser user, string provider, string providerUserId, IEnumerable<Claim> claims)> 
