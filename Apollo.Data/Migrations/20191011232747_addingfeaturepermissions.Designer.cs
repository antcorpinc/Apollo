...
namespace Apollo.Data.Migrations
{
    ...
    [Migration("20191011232747_addingfeaturepermissions")]
    partial class addingfeaturepermissions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apollo.Domain.Entity.Feature", b =>
                {
                    ...
                    b.Property<bool?>("IsMenuRequired");
            ...
            modelBuilder.Entity("Apollo.Domain.Entity.Form.FormType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Apollo.Domain.Entity.SocietyUser", b =>
                {
                    ...
                    b.HasOne("Apollo.Domain.Entity.ApolloUser", "User")
                        .WithOne("SocietyUser")
                        .HasForeignKey("Apollo.Domain.Entity.SocietyUser", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
